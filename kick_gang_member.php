...
try {
    ...
    // Pobierz dane wyrzucanego członka
    $stmt = $db->prepare("
        SELECT 
            c.id,
            gm.role
    ...
    if ($member['role'] === 'leader') {
        throw new Exception('Nie możesz wyrzucić lidera gangu.');
    }
    ...
    echo json_encode([
        'success' => true,
        'message' => "{$member_name} został wyrzucony z gangu!"
    ]);
